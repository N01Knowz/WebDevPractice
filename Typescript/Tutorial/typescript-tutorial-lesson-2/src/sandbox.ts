...
const TestingArrowFunctionWithOptionalParameter = (
  name?: string,
...
const TestingArrowFunctionWithRestParameters = (
  ...numbers: number[]
): number => {
...
console.log(
  "Arrow Function with data type:",
  TestingArrowFunctionWithDataType(13)
);
console.log(
  "Arrow Function with optional parameter:",
  TestingArrowFunctionWithOptionalParameter()
);
console.log(
  "Arrow Function with rest parameters:",
  TestingArrowFunctionWithRestParameters(1, 2, 3, 4, 5)
);

// Call Arrow Function with optional parameter and provide value only for 'name'
console.log(
  "Call Arrow Function with optional parameter and provide value only for 'name':",
  TestingArrowFunctionWithOptionalParameter("Alice")
);

// Arrow Function with parameters of type 'any'
const TestingArrowFunctionWithSingleAnyParameter = (arg: any): any => {
...
console.log(
  "Arrow Function with single parameter of type 'any':",
  TestingArrowFunctionWithSingleAnyParameter(13)
);

// Arrow Function with parameters of type 'any'
const TestingArrowFunctionWithAnyParameters = (...args: any[]): any => {
...
console.log(
  "Arrow Function with parameters of type 'any':",
  TestingArrowFunctionWithAnyParameters(13, "Hello", true, [1, 2, 3])
);

// Arrow Function returning void
const TestingArrowFunctionReturningVoid = (): void => {
...
function TestingTraditionalFunctionWithDataType(name: string): string {
  // Will return string
  return "Hello " + name;
}

let variableTraditionalReturnWithDataType =
  TestingTraditionalFunctionWithDataType("Mario"); // variableTraditionalReturnWithDataType will now only allow string type values because the function returns string.
...
function TestingTraditionalFunctionWithOptionalParameter(
  name?: string,
  greeting: string = "Hello"
): string {
  // Will return string
...
function TestingTraditionalFunctionWithRestParameters(
  ...numbers: number[]
): number {
  // Will return number
  return numbers.reduce((acc, curr) => acc + curr, 0);
...
console.log(
  "Traditional Function with data type:",
  TestingTraditionalFunctionWithDataType("Ron")
);
console.log(
  "Traditional Function with optional parameter:",
  TestingTraditionalFunctionWithOptionalParameter()
);
console.log(
  "Traditional Function with rest parameters:",
  TestingTraditionalFunctionWithRestParameters(1, 2, 3, 4, 5)
);

// Call Traditional Function with optional parameter and provide value only for 'name'
console.log(
  "Call Traditional Function with optional parameter and provide value only for 'name':",
  TestingTraditionalFunctionWithOptionalParameter("Alice")
);

// Traditional Function with parameters of type 'any'
function TestingTraditionalFunctionWithSingleAnyParameter(arg: any): any {
  // 'any' type allows any type of value for arg
  // Perform some operation with the argument
  return arg;
}
...
console.log(
  "Traditional Function with single parameter of type 'any':",
  TestingTraditionalFunctionWithSingleAnyParameter("Hello")
);

// Traditional Function with parameters of type 'any'
function TestingTraditionalFunctionWithAnyParameters(...args: any[]): any {
  // 'any' type allows any type of value for args
  // Perform some operation with arguments
  return args;
}
...
console.log(
  "Traditional Function with parameters of type 'any':",
  TestingTraditionalFunctionWithAnyParameters(13, "Hello", true, [1, 2, 3])
);

// Traditional Function returning void
function TestingTraditionalFunctionReturningVoid(): void {
  // Returns void. Whole purpose is that it should not return anything and just do something.
  console.log("This function returns void.");
}
...
let npc: {
  // Declare the properties and data type without any values. Make sure to use : and not = to declare the properties and its data type
  name: string;
  age: number;
  isMale: boolean;
...
interface villainProperties {
  // Does the same as npc variable but can be reused. interface can shape the properties and data types of an object.
  name: string;
  age: number;
  isMale: boolean;
}

let villain: villainProperties = {
...
const useInterfaceParameter = (person: Person) => { // Now this function only accepts a variable that is declared as Person interface
